...
namespace Flipdev\Productoptions\Ui\DataProvider\Product\Form\Modifier;
...
class CustomOptions extends \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\CustomOptions
{
            ...
            'children' => [
                'record' => [
                    ...
                    'children' => [
                        ...
                        static::FIELD_DESCRIPTION => $this->getDescriptionFieldConfig(52),
    ...
    /**
     * Get config for "Description" fields
     *
     * @param $sortOrder
     * @param array $options
     * @return array
                ...
                'arguments' => [
                    'data' => [
                        'config' => [
                            ...
                            'dataScope' => static::FIELD_DESCRIPTION,
                            'dataType' => Text::NAME,
                            'sortOrder' => $sortOrder
                        ],
                    ],
